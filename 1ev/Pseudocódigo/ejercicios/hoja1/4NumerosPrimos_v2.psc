Algoritmo NumerosPrimos
	...
	Repetir
		...
		Si num<0 o num2<0 Entonces
			Limpiar Pantalla
			Escribir "Los valores deben ser mayores o iguales que cero"
			Escribir "-------------------------------------------------"
			flag = Falso
		FinSi
	Hasta Que flag = Verdadero
		...
		//Si se diera el rango 1 hasta 1, no hay numeros primos y no se mostraría el siguiente mensaje
		Si cont > 0 Entonces
			Escribir "Estos números son: " Subcadena(nums, 0, Longitud(nums)-2)
		FinSi
FinAlgoritmo